        ...
        <div className="max-w-[620px]">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="border-r border-red-500/25 pr-3 last:border-r-0"
              >
          ...
          <a
            href="#kontakt"
            className="mt-7 inline-flex w-full items-center justify-center gap-4 rounded-lg bg-red-600 px-7 py-4 text-base font-black text-white shadow-[0_18px_60px_rgba(236,31,39,0.28)] transition hover:bg-red-500 sm:w-auto sm:min-w-[340px]"
          >
          ...
          <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <div className="flex items-center gap-3 rounded-lg border border-white/12 bg-white/[0.06] px-3 py-2.5 backdrop-blur">
            ...
            <div className="flex items-center gap-3 rounded-lg border border-white/12 bg-white/[0.06] px-3 py-2.5 backdrop-blur">
              ...
              <span className="text-sm font-medium">5 opinii w Google</span>
            </div>
          </div>
