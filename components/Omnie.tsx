    ...
    >
      ...
      <div className="relative z-10 mx-auto grid min-h-screen w-full max-w-7xl px-5 pb-8 pt-28 sm:px-8 lg:h-screen lg:grid-cols-[0.92fr_1.08fr] lg:px-12 lg:pb-7 lg:pt-32">
        <div className="relative lg:block">
          <div className="max-w-sm lg:absolute lg:-left-58 lg:top-0">
          ...
          <div className="mt-8 grid grid-cols-2 gap-3 lg:absolute lg:bottom-8 lg:right-50 lg:mt-0 lg:w-[92%] lg:grid-cols-4 lg:pr-0">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="rounded-lg border border-white/12 bg-black/45 p-3 backdrop-blur lg:bg-white/[0.055]"
              >
        ...
        <div className="mt-8 flex min-w-0 flex-col justify-center lg:mt-0 lg:pl-8">
          ...
          <div className="mt-5 min-h-[210px] rounded-lg border border-white/12 bg-black/45 p-5 backdrop-blur lg:bg-white/[0.045]">
