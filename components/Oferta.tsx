      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-col px-5 pb-8 pt-28 sm:px-8 lg:h-screen lg:px-12 lg:pb-5 lg:pt-[88px]">
        ...
        <div className="mt-5 grid flex-1 gap-4 lg:grid-cols-3 lg:items-stretch">
          {offers.map((offer) => (
            <article
              key={offer.title}
              className={`relative flex rounded-lg border bg-white/[0.035] p-4 backdrop-blur ${
                offer.popular
            ...
            >
              ...
              <div className="flex w-full flex-col pt-6">
                <offer.icon className="h-8 w-8 text-red-500" />
                ...
                <div className="mt-auto pt-4">
                  ...
                  <a
                        href="#kontakt"
                        className="mt-4 inline-flex w-full items-center justify-center gap-3 rounded-md border border-red-600 bg-black/20 px-5 py-2.5 text-sm font-black text-white transition hover:bg-red-600"
                        >
        ...
        <div className="mt-4 grid gap-4 rounded-lg border border-white/10 bg-white/[0.04] p-4 backdrop-blur lg:grid-cols-[1fr_1.3fr_auto] lg:items-center">
